...
class RankingsApi(object):
    ...
    def rankings_get(self, hero_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.rankings_get(hero_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.rankings_get_with_http_info(hero_id, **kwargs)
        else:
            (data) = self.rankings_get_with_http_info(hero_id, **kwargs)
            return data

    def rankings_get_with_http_info(self, hero_id, **kwargs):
        """
        GET /rankings
        Top players by hero
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.rankings_get_with_http_info(hero_id, callback=callback_function)
        ...
        if ('hero_id' not in params) or (params['hero_id'] is None):
            raise ValueError("Missing the required parameter `hero_id` when calling `rankings_get`")
        ...
        return self.api_client.call_api('/rankings', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
